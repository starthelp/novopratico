          ...
          <ul class="cadastro-indentado">
            <li>
              <div class="item form-group">
                <label style="line-height: 2.3em !important;" class="control-label col-md-3 col-sm-3 col-xs-12">Senha Antiga<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="senhaAntigaEmpregador" name="senhaAntigaEmpregador" class="form-control has-feedback-left" required="required" type="text" maxlength="10" placeholder="Digite a sua senha antiga"/>
            ...
            <li>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="senhaAtualizarEmpregador" name="senhaAtualizarEmpregador" onkeyup="checarSenha();" class="form-control has-feedback-left" required="required" type="password"  maxlength="10" placeholder="Digite a sua nova senha"/>
                  <span class="fa fa-key form-control-feedback left" style="line-height: 1.3em;" aria-hidden="true"></span>
                </div>
              </div>
            </li>
            <li>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="confirmSenhaAtualizarEmpregador" name="confirmSenhaAtualizarEmpregador" onkeyup="checarSenha();" class="form-control has-feedback-left" required="required" type="password" maxlength="10" placeholder="Confirme a sua senha"/>
                  <span class="fa fa-key form-control-feedback left" style="line-height: 1.3em;" aria-hidden="true"></span>
                </div>
              </div>
            </li>
                  ...
                  <ul class="cadastro-indentado" style="margin-top: 30px;">
                    <li>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nomeEmpregador" class="form-control has-feedback-left" name="nomeEmpregador" value="<?= $empregadores[0]->nomeempregador; ?>" class="form-control col-md-7 col-xs-12" readonly="true"/>
                    ...
                    <li>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-6">Celular<span class="required">*</span></label>
                        <div class="col-md-4 col-sm-6 col-xs-6">
                    ...
                    <li>
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6">
                          <input id="tituloEmpregador" class="form-control col-md-7 col-xs-6" type="text" name="tituloEmpregador" placeholder="Número do Título de Eleitor" value="<?= $empregadores[0]->tituloeleitor; ?>"/>
                        </div>
                      </div>
                    </li>
                    <li>
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-6">
                          <input id="irrfEmpregador" class="form-control col-md-7 col-xs-6" type="text" name="irrfEmpregador" placeholder="Número de Imposto / Renda" value="<?= $empregadores[0]->irrfrecibo; ?>"/>
                        </div>
                      </div>
                    </li>
                    <li>
                  ...
                  <ul class="cadastro-indentado" style="margin-top: 30px;">
                    ...
                    <li>
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <input id="numeroLogradouro" name="numeroLogradouro" class="date-picker form-control col-md-7 col-xs-12" required="required" value="<?= $empregadores[0]->numlogradouro;  ?>" type="text"/>
                        </div>
                      </div>
                    </li>
                    <li>
                    ...
                    <li>
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <select id="cidadeEmpregador" name="cidadeEmpregador" class="form-control">
                            <option value="<?= $empregadores[0]->idmunicipio; ?>" selected>  <?= $empregadores[0]->nomecidade; ?> </option>
                          </select>
                        </div>
                      </div>
                    </li>
                  ...
                  <ul class="cadastro-indentado" style="margin-top: 30px;">
                    ...
                    <li>
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <input class="form-control has-feedback-left" name="senhaEmpregador" id="senhaEmpregador" value="<?= $empregadores[0]->senha;  ?>" required="required" readOnly="true" type="password" disabled="true" />
                          <span class="fa fa-key form-control-feedback left" style="line-height: 1.3em;" aria-hidden="true"></span>
                        </div>
                      </div>
                    </li>
