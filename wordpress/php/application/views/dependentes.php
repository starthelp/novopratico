                ...
                <div class="x_content">
                  ...
                  if ($queryDependentes->num_rows() > 0):
                    ...
                    <table class="table table-responsive">
                      <thead>
                        <tr>
                          <th style="text-transform: uppercase;">Nome do Dependente</th>
                          ...
                          <th style="text-transform: uppercase; text-align: center;">Opções</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                        foreach ($cadastroDependente as $dependente):
                          ...
                          <tr>
                            ...
                            <td style="text-transform: uppercase;">
                              <?= $dependente->nomecolaborador; ?>
                            </td>
                            <td>
                              <?= $dependente->cpf; ?>
                            </td>
                            <td>
                              <?= date('d/m/Y',strtotime($dependente->nascimentodep)); ?>
                            </td>
                            <td>
                            ...
                            <td style="text-align: center;">
                              ...
                              <a href="#" title="Remover Dependente" data-id="<?= $dependente->id; ?>" data-nome="<?= $dependente->nomedependente; ?>" class="btn btn-danger btn-xs confirm_exclusao_dependente"><i class="fa fa-trash-o"></i> Deletar </a>
                            </td>
                          </tr>
                          <?php
                        endforeach;
                                        ...
                                        ?>
                                          ...
                                          <li>
                                            ...
                                            <div class="form-group">
                                              <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                                <input type="reset" name="resetarCadastro" id="resetarCadastro" class="btn btn-primary" value="Limpar Cadastro"/>
