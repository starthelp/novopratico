$(function()
{
  ...
  // verificar cidades dos empregadores
  $("#btn-editar-cidade-empregador").click(function()
  {
    $("#mostraCidade").css("display","none");
    $("#cidadeEmpregador").css("display","block");
    $("#btn-editar-cidade-empregador").css("display","none");
  });
